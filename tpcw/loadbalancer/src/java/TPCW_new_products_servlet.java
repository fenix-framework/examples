...
import pt.ist.fenixframework.example.tpcw.loadbalance.*;
...
public class TPCW_new_products_servlet extends HttpServlet {
	...
	throws IOException, ServletException {
		...
		*/
		...
		////////////////////////
		java.lang.StringBuffer linkUrl = req.getRequestURL();
		out.print("<p>The url that was used to open this page was:<br>"+linkUrl+"</p>");
		out.print("<p>The servlet path is:<br>"+req.getServletPath()+"</p>");
		out.print("<p>The servlet path into is:<br>"+req.getPathInfo()+"</p>");
		out.print("<p>The query string is:<br>"+req.getQueryString()+"</p>");
		out.print("<p>The context path is:<br>"+req.getContextPath()+"</p>");
		////////////////////////
